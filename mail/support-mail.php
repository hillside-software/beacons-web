...
$outgoingServerAddress      = 'smtp.sendgrid.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'beacons.app';
$sendingAccountPassword     = '1aldwych';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'sales@realestatebeacons.com'; // REQUIRED value.
$recipientName              = 'REBeacons Web Lead';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from RealEstateBeacons.com'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'RealEstateBeacons.com';                // REQUIRED value. This is used when a name or email is not collected from the website form
